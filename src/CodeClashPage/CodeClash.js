  ...
  const features = [
    {
      ...
      title: "Real Problems",
      description: "Industry-standard coding challenges that mirror real technical interviews"
    },
    {
      icon: <TeamOutlined className="feature-icon" />,
      title: "Peer Learning",
      description: "Collaborate and compete with fellow developers in real-time"
    },
    {
      icon: <TrophyOutlined className="feature-icon" />,
      title: "Win Prizes",
      description: "Top performers get recognized and rewarded at Hawkathon 2025"
    },
    {
...
const leaderboardDoc = await getDoc(doc(db, 'codeclash', 'leaderboard'));
  ...
  const handleCSVUpload = async ({ file }) => {
    try {
      ...
      if (error.code === 'permission-denied') {
        message.error('Permission denied. Please check your admin credentials.');
      } else {
  ...
  return (
    <div className="codeclash-page">
      ...
      >
        <Title className="neon-text" style={{ textAlign: 'center', marginBottom: '2rem' }}>
          CODE CLASH
        </Title>
        
        <Text className="gradient-text" style={{ display: 'block', textAlign: 'center', fontSize: '1.5rem', marginBottom: '3rem' }}>
        ...
        <div className="event-info">
          ...
          >
            <Title level={3} className="gradient-text" style={{ textAlign: 'center', marginBottom: '1rem' }}>
              BI-WEEKLY EVENT
            </Title>
            <Title level={1} className="neon-text" style={{ textAlign: 'center', marginBottom: '1rem' }}>
              FEB 21
            </Title>
            <Title level={3} style={{ textAlign: 'center', color: 'white', marginBottom: '0.5rem' }}>
              12-2PM
            </Title>
            <Title level={4} style={{ textAlign: 'center', color: 'white', marginBottom: '2rem' }}>
              Hemphill Hall 203
            </Title>
        ...
        <Text style={{ textAlign: 'center', color: 'white', marginTop: '2rem', display: 'block' }}>
      ...
      >
        ...
        >
          ...
          <p className="ant-upload-hint">
            The CSV should contain columns: S.N., Name of Participant, Hackerrank User ID, Score, TimeStamp
          </p>
        </Dragger>
      </Modal>
